...
/**
 * Testing the filter by Proximity view model
 */

public class FilterByProximityViewModelTest {

    private FilterByProximityViewModel viewModel;
    ...
    @BeforeEach
    public void setUp() {
        viewModel = new FilterByProximityViewModel();

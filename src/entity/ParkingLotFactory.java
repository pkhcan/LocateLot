...
public class ParkingLotFactory {
    ...
    public static ParkingLot createParkingLot(String id, String website, String carparkType, float[] latLong, String streetAddress, String halfHourlyRate, HashMap<String, String> timesToRates, int capacity) {

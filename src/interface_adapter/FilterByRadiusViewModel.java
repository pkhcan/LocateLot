...
public class FilterByRadiusViewModel {
    private List<ParkingLot> parkingLots;
    private String errorMessage;
    private final PropertyChangeSupport support;

    /**
     * FilterByRadiusViewModel monitors property changes and notifies view model with appropriate information.
     */
    public FilterByRadiusViewModel() {
